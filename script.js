...
fetch('https://api.openweathermap.org/data/2.5/forecast?q='+newName.value+'&appid=f9b02d5d268dbffd7f4dd4e1de87e358')
...
function DefaultScreen(){
    document.getElementById("cityInput").defaultValue = "Fredericton";
    GetInfo();
}
